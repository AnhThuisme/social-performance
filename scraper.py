...
ROW_SCRAPE_RETRY_DELAY_SECONDS = max(0.0, float(os.getenv("ROW_SCRAPE_RETRY_DELAY_SECONDS", "0.9")))
FAILED_ROW_RETRY_PASSES = max(0, int(os.getenv("FAILED_ROW_RETRY_PASSES", "1")))
FAILED_ROW_RETRY_DELAY_SECONDS = max(0.0, float(os.getenv("FAILED_ROW_RETRY_DELAY_SECONDS", "1.5")))
